 ...
 */
final case class LagDstrMatrix[T: ClassTag](
  override val hc: LagContext,
 ...
 *
 */
final case class LagDstrVector[T: ClassTag](
  override val hc: LagContext,
...
// ********
// SMP MATRIX
final case class LagSmpMatrix[T: ClassTag](
  override val hc: LagContext,
  ...
  //    LagSmpMatrix(this.hc, rcvMap.map{case(k:(Long, Long), v:T) => ((k._2,k._1),v)}, GpiSparseRowMatrix.transpose(vov))
...
// LagAdaptiveVector
// MATRIX
final case class LagSmpVector[T: ClassTag](
  override val hc: LagContext,
  v: GpiAdaptiveVector[T])
